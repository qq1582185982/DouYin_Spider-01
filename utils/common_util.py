...
def init():
    media_base_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../downloads/media'))
    excel_base_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../downloads/excel'))
